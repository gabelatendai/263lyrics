    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
            ...
            <div class="br-section-wrapper">
                <h6 class="br-section-label">Current Artistes</h6>
                <p class="br-section-text">Add, Edit, Update and Delete Artistes
                    <a class="btn btn-success" style="color: #FFF; float: right" data-toggle="modal"
                       data-target="#modaldemo1">Add Artistes</a>
                </p>
                ...
                <div class="table-wrapper">
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        $sliders = R::findAll('users', 'type = ?',['artist']);
                        ...
                        foreach ($sliders as $slider) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $slider->fname.' ' . $slider->sname ?></td>
                                <td><?php echo $slider->type ?></td>
                                <td><?php echo $slider->address ?></td>
					                            ...
					                            <div class="modal-content">
						                            ...
						                            <div class="modal-body">
							                            ...
							                            <div class="modal-footer">
								                            ...
								                            <a href="delete-artistes.php<?php echo '?id='.$id; ?>" style="margin-bottom:5px;" class="btn btn-primary"><i class="glyphicon glyphicon-ok icon-white"></i> Yes</a>
							                            </div>
						                            </div>
					                            </div>
				                            </div>
