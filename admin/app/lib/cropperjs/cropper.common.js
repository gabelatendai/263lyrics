 ...
 * @param {number} start - The start index.php.
...
function () {
  ...
  _createClass(Cropper, [{
    ...
    value: function start() {
      ...
      if (!IS_SAFARI) {
        sizingImage.style.cssText = 'left:0;' + 'max-height:none!important;' + 'max-width:none!important;' + 'min-height:0!important;' + 'min-width:0!important;' + 'opacity:0;' + 'position:absolute;' + 'top:0;' + 'z-index.php:-1;';
