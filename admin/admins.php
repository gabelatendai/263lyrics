...
if (isset($_POST['save'])) {
    ...
    $email = $_POST['email'];
    $init = R::findOne('admin', 'email = ? ', [$email]);
    if($pass != $passconfrm){
	...
	<div class="br-mainpanel">
		...
		<div class="br-pagebody">
			...
			<div class="br-section-wrapper">
				...
				<p class="br-section-text">Add, Edit, Update and Delete Admins

					<a class="btn btn-success" style="color: #FFF; float: right" data-toggle="modal"
					   data-target="#modaldemo1">Add New Admin</a>
				</p>
				...
				<table id="datatable1" class="table display responsive nowrap">
                    ...
                    foreach ($sliders as $slider) {
						...
						<tr>
							...
							<td><a class="pull-right" href="updateprofile?id=<?php echo $id;?>">
									<b> <p>Edit</p></b></a>
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												...
												<div class="modal-footer">
													...
													<a href="admin_delete<?php echo '?id='.$id; ?>" style="margin-bottom:5px;" class="btn btn-primary"><i class="glyphicon glyphicon-ok icon-white"></i> Yes</a>
												</div>
											</div>
										</div>
									</div>
